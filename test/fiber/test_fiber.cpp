...
int main() {
    ...
    logger->add_appender(acid::LogAppender::ptr(new acid::FileLogAppender("./test_log.log", acid::LogLevel::INFO)));
...
//    for (int i = 0; i < 2; ++i) {
//        threads.push_back(acid::Thread::ptr(new acid::Thread(test_fiber, "m_thread" + std::to_string(i))));
//    }
//
//    for (auto i : threads) {
//        i->join();
